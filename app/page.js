            ...
            <section className="container px-4 py-10 mx-auto lg:h-128 lg:space-x-8 lg:flex lg:items-center">
                <div className="w-full text-center lg:text-left lg:w-1/2 lg:-mt-8">
                    <h1 className="text-3xl leading-snug text-gray-800 dark:text-gray-200 md:text-4xl">
                        Discover <span className="font-semibold">Shahzaib Hassan</span> Tech Journey <br className="hidden lg:block" /> and explore <span className="font-semibold underline decoration-primary"><span ref={el} /></span>
                    </h1>
                    <p className="mt-4 text-lg text-gray-500 dark:text-gray-300">
                        Welcome to my blog! I’m Shahzaib Hassan, a passionate coder with over 2 years of experience in programming. I’m dedicated to sharing my journey, insights, and resources on coding and technology. My blog aims to help aspiring developers and tech enthusiasts by providing practical advice, tutorials, and updates on the latest trends.
                    </p>
                    <p className="mt-4 text-lg text-gray-500 dark:text-gray-300">
                        Whether you're looking for guidance on mastering new skills or want to stay updated with the latest in programming, you'll find valuable information here. Dive into various topics and join me as I continue to explore and contribute to the tech world.
                    </p>
